...
if(isset($_POST['submit'])){
    ...
    $result = $Categories->createCategory($nama_category, $deskripsi,$deadline,$status);
    if($result[0] == true){
...
<body>
    ...
    <form method="post" action="">
        <div class="mb-4">
            ...
            <input type="text" name="nama_category" id="nama_category" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
        </div>
        <div class="mb-4">
            <label for="deskripsi" class="block text-gray-700 font-bold mb-2">Deskripsi</label>
            <textarea class="border-2 w-full p-2" name="deskripsi" id="deskripsi" cols="30" rows="10"></textarea>
        </div>
        <div class="mb-4">
