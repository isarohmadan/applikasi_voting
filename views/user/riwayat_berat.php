...
$Logic = new Logic();
$riwayat_riwayat = $Logic->getRiwayatBerat($_SESSION['id']);
...
<body>
    ...
    foreach($riwayat_riwayat as $riwayat){ ?>
        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
            ...
            <td class="px-6 py-4"><?=$riwayat["berat_awal"]?> <?=$riwayat["berat_dari"]?> | Konfersi Ke | <?=$riwayat["berat_akhir"]?> <?=$riwayat["berat_ke"]?></td>
